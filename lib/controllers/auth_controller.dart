...
final user = await FirebaseAuth.instance.signInAnonymously();
  ...
  Future<void> saveUserAnonim(UserCredential account) async {
    userFR
        .doc(account.user?.email ?? "gmail")
     .set({"email" : "gmail", "name": "anonim", "profilepic": "oma"});
  }
